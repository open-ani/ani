 ...
 */
public class `PatternTitleParserTest吹响吧！上低音号` : PatternBasedTitleParserTestSuite() {
    @Test
    public fun `670314_4_Hibike_21_Euphonium_S3_06_BIG5_1080P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第06話 BIG5 1080P MP4（字幕社招人內詳）")
    ...
    public fun `670313_4_Hibike_21_Euphonium_S3_06_BIG5_720P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第06話 BIG5 720P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `670276_Hibike_21_Euphonium_3_07_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [07][WebRip][HEVC_AAC][简繁日内封][招募时轴]")
    ...
    public fun `670275_Hibike_21_Euphonium_3_07_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [07][WebRip][HEVC_AAC][简日内嵌][招募时轴]")
        assertEquals("07..07", r.episodeRange.toString())
    ...
    public fun `670274_Hibike_21_Euphonium_3_07_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹響吧！上低音號 第三季 / Hibike! Euphonium 3 [07][WebRip][HEVC_AAC][繁日內嵌][招募時軸]")
        assertEquals("07..07", r.episodeRange.toString())
    ...
    public fun `670253_4_Hibike_21_Euphonium_S3_06_GB_1080P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第06话 GB 1080P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `670252_4_Hibike_21_Euphonium_S3_06_GB_720P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第06话 GB 720P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669928_4_Hibike_21_Euphonium_S3_05_BIG5_1080P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第05話 BIG5 1080P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669927_4_Hibike_21_Euphonium_S3_05_BIG5_720P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第05話 BIG5 720P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669692_Hibike_21_Euphonium_3_05_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹響吧！上低音號 第三季 / Hibike! Euphonium 3 [06][WebRip][HEVC_AAC][繁日內嵌][招募時軸]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669691_Hibike_21_Euphonium_3_06_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [06][WebRip][HEVC_AAC][简日内嵌][招募时轴]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669690_Hibike_21_Euphonium_3_06_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [06][WebRip][HEVC_AAC][简繁日内封][招募时轴]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669239_4_Hibike_21_Euphonium_S3_05_GB_1080P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第05话 GB 1080P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `669238_4_Hibike_21_Euphonium_S3_05_GB_720P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第05话 GB 720P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668979_Hibike_21_Euphonium_3_05_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [05][WebRip][HEVC_AAC][简繁日内封][招募时轴]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668978_Hibike_21_Euphonium_3_05_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹響吧！上低音號 第三季 / Hibike! Euphonium 3 [05][WebRip][HEVC_AAC][繁日內嵌][招募時軸]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668971_Hibike_21_Euphonium_3_05_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [05][WebRip][HEVC_AAC][简日内嵌][招募时轴]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668891_4_Hibike_21_Euphonium_S3_04_BIG5_1080P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第04話 BIG5 1080P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668890_4_Hibike_21_Euphonium_S3_04_BIG5_720P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第04話 BIG5 720P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668694_4_Hibike_21_Euphonium_S3_04_GB_1080P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第04话 GB 1080P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668693_4_Hibike_21_Euphonium_S3_04_GB_720P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第04话 GB 720P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668465_Hibike_21_Euphonium_3_04_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [04][WebRip][HEVC_AAC][简繁日内封][招募时轴]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668464_Hibike_21_Euphonium_3_04_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [04][WebRip][HEVC_AAC][简日内嵌][招募时轴]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668463_Hibike_21_Euphonium_3_04_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹響吧！上低音號 第三季 / Hibike! Euphonium 3 [04][WebRip][HEVC_AAC][繁日內嵌][招募時軸]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668410_4_Hibike_21_Euphonium_S3_03_BIG5_1080P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第03話 BIG5 1080P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668409_4_Hibike_21_Euphonium_S3_03_BIG5_720P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第03話 BIG5 720P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668337_4_Hibike_21_Euphonium_S3_03_GB_1080P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第03话 GB 1080P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668336_4_Hibike_21_Euphonium_S3_03_GB_720P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第03话 GB 720P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668203_4_Hibike_21_Euphonium_S3_02_BIG5_1080P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第02話 BIG5 1080P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668202_4_Hibike_21_Euphonium_S3_02_BIG5_720P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第02話 BIG5 720P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668111_4_Hibike_21_Euphonium_S3_02_GB_1080P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第02话 GB 1080P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `668110_4_Hibike_21_Euphonium_S3_02_GB_720P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第02话 GB 720P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667411_4_Hibike_21_Euphonium_S3_01_BIG5_1080P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第01話 BIG5 1080P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667410_4_Hibike_21_Euphonium_S3_01_BIG5_720P_MP4`() {
        val r =
            parse("【極影字幕社】★4月新番 吹響吧！上低音號 第三季/Hibike! Euphonium S3 第01話 BIG5 720P MP4（字幕社招人內詳）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667298_Hibike_21_Euphonium_3_02_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [02][WebRip][HEVC_AAC][简日内嵌][招募时轴]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHS, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667297_Hibike_21_Euphonium_3_02_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹響吧！上低音號 第三季 / Hibike! Euphonium 3 [02][WebRip][HEVC_AAC][繁日內嵌][招募時軸]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667290_4_Hibike_21_Euphonium_S3_01_GB_1080P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第01话 GB 1080P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667289_4_Hibike_21_Euphonium_S3_01_GB_720P_MP4`() {
        val r =
            parse("【极影字幕社】★4月新番 吹响吧！上低音号 第三季/Hibike! Euphonium S3 第01话 GB 720P MP4（字幕社招人内详）")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `667286_Hibike_21_Euphonium_3_02_WebRip_HEVC_AAC`() {
        val r =
            parse("[北宇治字幕组] 吹响吧！上低音号 第三季 / Hibike! Euphonium 3 [02][WebRip][HEVC_AAC][简繁日内封][招募时轴]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHS, CHT, JPN", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `560011_DHR_Chikai_no_Finale_BDRip_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢】[吹響吧！上低音號～誓言的終章～_Chikai no Finale][劇場版][BDRip][繁體][720P][MP4]")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    ...
    fun `532705_U3_Web_2019_Movie_BIG5_GP_WEB_DL_1080p_AVC_AAC_2_0_5_1_MP4_Gekijouban_Hibike_21_Euphonium_Chikai_no_Finale_Sound_21_Euphonium_the_Movie__Our_Promise_A_Brand_New_Day_`() {
        ...
        assertEquals(")..)", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `518747_DHR_Liz_to_Aoi_Tori_BDRip_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢】[吹響吧！上低音號～莉茲與青鳥～_Liz to Aoi Tori][劇場版][BDRip][繁體][720P][MP4]")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `472387_DHR_Sound_21Euphonium_S2_SP01_07_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][SP01-07全][繁體][720P][MP4]")
        assertEquals("SP01-07全..SP01-07全", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `451096_DHR_Sound_21Euphonium_S2_13_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][13完][繁體][720P][MP4]")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `450972_DHR_Sound_21Euphonium_S2_12_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][12][繁體][720P][MP4]")
    ...
    public fun `450432_DHR_Sound_21Euphonium_S2_11_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][11][繁體][720P][MP4]")
    ...
    public fun `449623_DHR_Sound_21Euphonium_S2_10_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][10][繁體][720P][MP4]")
        assertEquals("10..10", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `449463_DHR_Sound_21Euphonium_S2_09_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][09][繁體][720P][MP4]")
    ...
    public fun `448293_DHR_Sound_21Euphonium_S2_07_08_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][07-08][繁體][720P][MP4]")
        assertEquals("null", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `447289_DHR_Sound_21Euphonium_S2_06_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][06][繁體][720P][MP4]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `446678_DHR_Sound_21Euphonium_S2_05_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][05][繁體][720P][MP4]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `446286_DHR_Sound_21Euphonium_S2_04_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][04][繁體][720P][MP4]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `445712_DHR_Sound_21Euphonium_S2_03_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][03][繁體][720P][MP4]")
        assertEquals("03..03", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `445317_DHR_Sound_21Euphonium_S2_02_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][02][繁體][720P][MP4]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `444585_DHR_Sound_21Euphonium_S2_01_720P_MP4`() {
        val r =
            parse("【DHR動研字幕組&茉語星夢&千夏字幕組】[吹響吧！上低音號 第二季_Sound!Euphonium S2][01][繁體][720P][MP4]")
        assertEquals("01..01", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    fun `442933_LowPower_Raws_Hibike_21_Euphonium_Kitauji_Koukou_Suisougaku_Bu_e_Youkoso___Movie_BD_1080P_x264_FLAC`() {
        ...
        assertEquals("Movie..Movie", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    fun `442727_Ohys_Raws_Gekijouban_Hibike_21_Euphonium___Kitauji_Koukou_Suisougaku_Bu_e_Youkoso_BD_1280x720_x264_AACx3`() {
        ...
        assertEquals(
            "Kitauji Koukou Suisougaku Bu e Youkoso..Kitauji Koukou Suisougaku Bu e Youkoso",
    ...
    public fun `422536_F_SP_01_07_1080P_MP4`() {
        ...
        assertEquals("07 简 1080P MP4..07 简 1080P MP4", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("null", r.resolution.toString())
    }
    ...
    public fun `401721_04_Hibike_21_Euphonium_01__13_720P_GB_MP4`() {
        ...
        assertEquals("01--13..01--13", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `399320_04_Hibike_21_Euphonium_01__13_1080P_MKV`() {
        val r =
            parse("【極影字幕社】★04月新番[吹響吧！上低音號Hibike! Euphonium ][第01--13話][合集][1080P][繁简内封][附字体].MKV")
        assertEquals("01--13..01--13", r.episodeRange.toString())
        assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `399295_04_Hibike_21_Euphonium_13_END_1080P_MKV`() {
        val r =
            parse("【極影字幕社】★04月新番[吹響吧！上低音號Hibike! Euphonium ][第13話]END[1080P][繁简内封][附字体].MKV")
    ...
    public fun `393818_04_Hibike_21_Euphonium_06_V2_720P_BIG5_mp4`() {
        ...
        assertEquals("06話V2版..06話V2版", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `391310_04_Hibike_21_Euphonium_03_v2_720P_BIG5_mp4`() {
        ...
        assertEquals("03話v2版..03話v2版", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }
    ...
    public fun `390515_04_Hibike_21_Euphonium_02_V2_720P_BIG5_mp4`() {
        ...
        assertEquals("02話V2版..02話V2版", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("720P", r.resolution.toString())
    }

 ...
 */
public class `PatternTitleParserTest無職轉生～到了異世界就拿出真本事～` : PatternBasedTitleParserTestSuite() {
    @Test
    public fun `669857_4_Mushoku_Tensei_II_18_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][4月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][18][1080p][MP4][简中]")
    ...
    public fun `669856_4_Mushoku_Tensei_II_18_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][4月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][18][1080p][MP4][繁中]")
        assertEquals("18..18", r.episodeRange.toString())
    ...
    public fun `669849_S2_Mushoku_Tensei_S2_18_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [18][1080p@60FPS][繁體內嵌]")
        assertEquals("18..18", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `669847_S2_Mushoku_Tensei_S2_18_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [18][1080p@60FPS][简体内嵌]")
        assertEquals("18..18", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `669757_Mushoku_Tensei___Season_2_18_WebRip_HEVC_AAC`() {
        ...
        assertEquals("Season 2..Season 2", r.episodeRange.toString())
        assertEquals("CHS, CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
    ...
    public fun `669263_4_Mushoku_Tensei_II_17_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][4月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][17][1080p][MP4][简中]")
    ...
    public fun `669262_4_Mushoku_Tensei_II_17_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][4月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][17][1080p][MP4][繁中]")
        assertEquals("17..17", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `669131_S2_Mushoku_Tensei_S2_17_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [17][1080p@60FPS][繁體內嵌]")
        assertEquals("17..17", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `669129_S2_Mushoku_Tensei_S2_17_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [17][1080p@60FPS][简体内嵌]")
        assertEquals("17..17", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `668753_4_Mushoku_Tensei_II_16_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][4月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][16][1080p][MP4][简中]")
    ...
    public fun `668752_4_Mushoku_Tensei_II_16_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][4月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][16][1080p][MP4][繁中]")
        assertEquals("16..16", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `668579_S2_Mushoku_Tensei_S2_16_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [16][1080p@60FPS][繁體內嵌]")
        assertEquals("16..16", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `668578_S2_Mushoku_Tensei_S2_16_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [16][1080p@60FPS][简体内嵌]")
        assertEquals("16..16", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `668175_4_Mushoku_Tensei_II_15_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][4月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][15][1080p][MP4][简中]")
    ...
    public fun `668174_4_Mushoku_Tensei_II_15_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][4月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][15][1080p][MP4][繁中]")
        assertEquals("15..15", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `668074_S2_Mushoku_Tensei_S2_15_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [15][1080p@60FPS][繁體內嵌]")
        assertEquals("15..15", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `668073_S2_Mushoku_Tensei_S2_15_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [15][1080p@60FPS][简体内嵌]")
        assertEquals("15..15", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `667599_S2_Mushoku_Tensei_S2_14_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [14][1080p@60FPS][繁體內嵌]")
        assertEquals("14..14", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `667598_S2_Mushoku_Tensei_S2_14_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [14][1080p@60FPS][简体内嵌]")
        assertEquals("14..14", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `667477_4_Mushoku_Tensei_II_14_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][4月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][14][1080p][MP4][简中]")
        assertEquals("14..14", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `667476_4_Mushoku_Tensei_II_14_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][4月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][14][1080p][MP4][繁中]")
        assertEquals("14..14", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `666957_S2_Mushoku_Tensei_S2_13_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [13][1080p@60FPS][繁體內嵌]")
        assertEquals("13..13", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `666956_S2_Mushoku_Tensei_S2_13_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [13][1080p@60FPS][简体内嵌]")
        assertEquals("13..13", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `666610_4_Mushoku_Tensei_II_13_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][4月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][13][1080p][MP4][简中]")
        assertEquals("13..13", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `666609_4_Mushoku_Tensei_II_13_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][4月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][13][1080p][MP4][繁中]")
        assertEquals("13..13", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `652096_S2_Mushoku_Tensei_S2_12_1080p_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [12][1080p@60FPS][繁體內嵌]")
        assertEquals("12..12", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `652095_S2_Mushoku_Tensei_S2_12_1080p_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [12][1080p@60FPS][简体内嵌]")
        assertEquals("12..12", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `651837_7_Mushoku_Tensei_II_11_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][11][1080p][MP4][简中]")
    ...
    public fun `651836_7_Mushoku_Tensei_II_11_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][11][1080p][MP4][繁中]")
        assertEquals("11..11", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `651835_7_Mushoku_Tensei_II_10_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][10][1080p][MP4][简中]")
    ...
    public fun `651834_7_Mushoku_Tensei_II_10_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][10][1080p][MP4][繁中]")
        assertEquals("10..10", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `651552_S2_Mushoku_Tensei_S2_11_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [11][1080P@60FPS][繁體內嵌]")
        assertEquals("11..11", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `651551_S2_Mushoku_Tensei_S2_11_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [11][1080P@60FPS][简体内嵌]")
        assertEquals("11..11", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `650946_S2_Mushoku_Tensei_S2_10_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [10][1080P@60FPS][繁體內嵌]")
        assertEquals("10..10", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `650945_S2_Mushoku_Tensei_S2_10_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [10][1080P@60FPS][简体内嵌]")
        assertEquals("10..10", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `650775_7_Mushoku_Tensei_II_09_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][09][1080p][MP4][简中]")
    ...
    public fun `650774_7_Mushoku_Tensei_II_09_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][09][1080p][MP4][繁中]")
        assertEquals("09..09", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `650450_S2_Mushoku_Tensei_S2_09_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [09][1080P@60FPS][繁體內嵌]")
        assertEquals("09..09", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `650449_S2_Mushoku_Tensei_S2_09_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [09][1080P@60FPS][简体内嵌]")
        assertEquals("09..09", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649892_7_Mushoku_Tensei_II_08_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][08][1080p][MP4][简中]")
        assertEquals("08..08", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649891_7_Mushoku_Tensei_II_08_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][08][1080p][MP4][繁中]")
        assertEquals("08..08", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649762_S2_Mushoku_Tensei_S2_08_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [08][1080P@60FPS][繁體內嵌]")
        assertEquals("08..08", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649761_S2_Mushoku_Tensei_S2_08_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [08][1080P@60FPS][简体内嵌]")
        assertEquals("08..08", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649363_7_Mushoku_Tensei_II_07_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][07][1080p][MP4][简中]")
        assertEquals("07..07", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649362_7_Mushoku_Tensei_II_07_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][07][1080p][MP4][繁中]")
        assertEquals("07..07", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649161_S2_Mushoku_Tensei_S2_07_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [07][1080P@60FPS][繁體內嵌]")
        assertEquals("07..07", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `649160_S2_Mushoku_Tensei_S2_07_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [07][1080P@60FPS][简体内嵌]")
        assertEquals("07..07", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `648630_7_Mushoku_Tensei_II_06_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][06][1080p][MP4][简中]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `648629_7_Mushoku_Tensei_II_06_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][06][1080p][MP4][繁中]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `648521_S2_Mushoku_Tensei_S2_06_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [06][1080P@60FPS][繁體內嵌]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `648520_S2_Mushoku_Tensei_S2_06_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [06][1080P@60FPS][简体内嵌]")
        assertEquals("06..06", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647999_7_Mushoku_Tensei_II_05_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][05][1080p][MP4][简中]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647998_7_Mushoku_Tensei_II_05_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][05][1080p][MP4][繁中]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647908_7_Mushoku_Tensei_II_04_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][04][1080p][MP4][简中]")
    ...
    public fun `647907_7_Mushoku_Tensei_II_04_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][04][1080p][MP4][繁中]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647901_S2_Mushoku_Tensei_S2_05_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [05][1080P@60FPS][繁體內嵌]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647900_S2_Mushoku_Tensei_S2_05_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [05][1080P@60FPS][简体内嵌]")
        assertEquals("05..05", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647404_S2_Mushoku_Tensei_S2_04_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [04][1080P@60FPS][繁體內嵌]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647403_S2_Mushoku_Tensei_S2_04_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [04][1080P@60FPS][简体内嵌]")
        assertEquals("04..04", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `647012_7_Mushoku_Tensei_II_03_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][03][1080p][MP4][简中]")
    ...
    public fun `647011_7_Mushoku_Tensei_II_03_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][03][1080p][MP4][繁中]")
        assertEquals("03..03", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `646794_S2_Mushoku_Tensei_S2_03_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [03][1080P@60FPS][繁體內嵌]")
        assertEquals("03..03", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `646793_S2_Mushoku_Tensei_S2_03_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [03][1080P@60FPS][简体内嵌]")
        assertEquals("03..03", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `646114_S2_Mushoku_Tensei_S2_02_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [02][1080P@60FPS][繁體內嵌]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `646113_S2_Mushoku_Tensei_S2_02_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [02][1080P@60FPS][简体内嵌]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `645984_7_Mushoku_Tensei_II_02_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][02][1080p][MP4][简中]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `645983_7_Mushoku_Tensei_II_02_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][02][1080p][MP4][繁中]")
        assertEquals("02..02", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `645364_S2_Mushoku_Tensei_S2_01_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [01][1080P@60FPS][繁體內嵌]")
        assertEquals("01..01", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `645363_S2_Mushoku_Tensei_S2_01_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [01][1080P@60FPS][简体内嵌]")
        assertEquals("01..01", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `645334_7_Mushoku_Tensei_II_01_1080p_MP4`() {
        val r =
            parse("[爱恋字幕社&漫猫字幕社][7月新番][无职转生Ⅱ ～到了异世界就拿出真本事～][Mushoku Tensei II][01][1080p][MP4][简中]")
        assertEquals("01..01", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `645333_7_Mushoku_Tensei_II_01_1080p_MP4`() {
        val r =
            parse("[愛戀字幕社&漫貓字幕社][7月新番][無職轉生Ⅱ ～到了異世界就拿出真本事～][Mushoku Tensei II][01][1080p][MP4][繁中]")
        assertEquals("01..01", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `644771_S2_Mushoku_Tensei_S2_00_1080P_60FPS`() {
        val r =
            parse("[桜都字幕組] 無職轉生～到了異世界就拿出真本事～ S2 / Mushoku Tensei S2 [00][1080P@60FPS][繁體內嵌]")
        assertEquals("00..00", r.episodeRange.toString())
        assertEquals("CHT", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    public fun `644769_S2_Mushoku_Tensei_S2_00_1080P_60FPS`() {
        val r =
            parse("[桜都字幕组] 无职转生～到了异世界就拿出真本事～ S2 / Mushoku Tensei S2 [00][1080P@60FPS][简体内嵌]")
        assertEquals("00..00", r.episodeRange.toString())
        assertEquals("CHS", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }
    ...
    fun `602366_VCB_Studio_Mushoku_Tensei_Isekai_Ittara_Honki_Dasu_10_bit_1080p_HEVC_BDRip_S1_Fin`() {
        ...
        assertEquals("bit 1080p HEVC BDRip..bit 1080p HEVC BDRip", r.episodeRange.toString())
    ...
    public fun `572626__Raws_11th_anniversary_BDRip_1080P_x265_10bit__FLAC_ALL`() {
        ...
        assertEquals("FLAC]..FLAC]", r.episodeRange.toString())
        assertEquals("", r.subtitleLanguages.sortedBy { it.id }.joinToString { it.id })
        assertEquals("1080P", r.resolution.toString())
    }

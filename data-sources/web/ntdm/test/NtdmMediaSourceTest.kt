...
class NtdmMediaSourceTest {
    ...
    fun `parse search result`() {
        ...
        list[0].run {
            ...
            assertEquals("https://www.mxdm4.com/video/4621.html", url)
        }
    }
    ...
    fun `parse bangumi result`() {
        ...
        list[0].run {
            ...
            assertEquals("https://www.mxdm4.com/play/4621-1-1.html", url)
            assertEquals("第一线路", channel)
        }
        list[13].run {
            assertEquals("第02集", name)
            assertEquals("https://www.mxdm4.com/play/4621-2-2.html", url)

...
import me.him188.ani.api.impl.model.KeyedMutableListFlow
import me.him188.ani.api.model.SearchSession
    ...
    fun launchFetchNextPage(
        ...
        while (true) {
            ...
            if (value is FetchingState.Fetching) {
                ...
                // not fetching
                if (fetchingState.compareAndSet(
                        value,
                        FetchingState.Fetching(searchSession.query)
                    )
                ) {
                    // set fetching
                    break
